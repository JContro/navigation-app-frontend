...
const Map = ({ children, className, width, height, ...rest }) => {
  ...
  // const { crowFliesData, crowFliesIsLoading, crowfliesIsError } = useCrowFlies(
  //   markers.length === 3 ? markers : null
  // );
    ...
    <MapContainer className={mapClassName} {...rest}>
      ...
      <LayersControl position="topright">
        ...
        <LayersControl.Overlay name="Circle">
          <LayerGroup>
            <Circle center={center} pathOptions={fillBlueOptions} radius={20} />
